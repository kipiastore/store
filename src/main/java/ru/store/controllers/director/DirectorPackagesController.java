 ...
 */
@Controller
public class DirectorPackagesController {

    @Autowired
    private PackageService packageService;

    @RequestMapping(value = "/director/packages", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/director/addpackage", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/director/updatepackage", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/director/deletepackage", method = RequestMethod.POST)
    ...
    private void loadPage(ModelAndView modelAndView, Model model) {
        ...
        modelAndView.setViewName("director/packages");
    }
    ...
    @RequestMapping(value = "/director/addpackage", method = RequestMethod.GET)
    public String redirect1() {
        return "redirect:/director/packages";
    }
    @RequestMapping(value = "/director/deletepackage", method = RequestMethod.GET)
    public String redirect2() {
        return "redirect:/director/packages";
    }
    @RequestMapping(value = "/director/updatepackage", method = RequestMethod.GET)
