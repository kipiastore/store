 ...
 */
@Controller
public class DirectorRegionsController {

    @Autowired
    private RegionService regionService;

    @RequestMapping(value = "/director/regions", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/director/addregion", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/director/deleteregion", method = RequestMethod.POST)
    ...
    private void loadPage(ModelAndView modelAndView, Model model) {
        ...
        modelAndView.setViewName("director/regions");
    }
    ...
    @RequestMapping(value = "/director/addregion", method = RequestMethod.GET)
    public String redirect1() {
        return "redirect:/director/regions";
    }
    @RequestMapping(value = "/director/deleteregion", method = RequestMethod.GET)
