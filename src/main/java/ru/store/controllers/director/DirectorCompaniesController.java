 ...
 */
@Controller
public class DirectorCompaniesController {
    ...
    @RequestMapping(value = "/director/companies", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/director/updatecompany", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/director/deletecompany", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/director/searchcompany", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/director/addcompany", method = RequestMethod.GET)
    public String redirect1() {
        return "redirect:/director/companies";
    }
    @RequestMapping(value = "/director/updatecompany", method = RequestMethod.GET)
    public String redirect2() {
        return "redirect:/director/companies";
    }
    @RequestMapping(value = "/director/deletecompany", method = RequestMethod.GET)
    public String redirect3() {
        return "redirect:/director/companies";
    }
    @RequestMapping(value = "/director/searchcompany", method = RequestMethod.GET)
    ...
    private void loadPage(Model model, ModelAndView modelAndView) {
        ...
        modelAndView.setViewName("director/companies");
    }
