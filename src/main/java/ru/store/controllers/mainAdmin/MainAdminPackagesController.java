 ...
 */
@Controller
public class MainAdminPackagesController {

    @Autowired
    private PackageService packageService;

    @RequestMapping(value = "/mainAdmin/packages", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/mainAdmin/addpackage", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/mainAdmin/updatepackage", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/mainAdmin/deletepackage", method = RequestMethod.POST)
    ...
    private void loadPage(ModelAndView modelAndView, Model model) {
        ...
        modelAndView.setViewName("mainAdmin/packages");
    }
    ...
    @RequestMapping(value = "/mainAdmin/addpackage", method = RequestMethod.GET)
    public String redirect1() {
        return "redirect:/mainAdmin/packages";
    }
    @RequestMapping(value = "/mainAdmin/deletepackage", method = RequestMethod.GET)
    public String redirect2() {
        return "redirect:/mainAdmin/packages";
    }
    @RequestMapping(value = "/mainAdmin/updatepackage", method = RequestMethod.GET)
