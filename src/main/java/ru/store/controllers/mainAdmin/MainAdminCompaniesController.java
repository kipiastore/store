 ...
 */
@Controller
public class MainAdminCompaniesController {
    ...
    @RequestMapping(value = "/mainAdmin/companies", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/mainAdmin/addcompany", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/mainAdmin/updatecompany", method = RequestMethod.POST)
...
try {
    ...
    @RequestMapping(value = "/mainAdmin/deletecompany", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/mainAdmin/searchcompany", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/mainAdmin/addcompany", method = RequestMethod.GET)
    public String redirect1() {
        return "redirect:/mainAdmin/companies";
    }
    @RequestMapping(value = "/mainAdmin/updatecompany", method = RequestMethod.GET)
    public String redirect2() {
        return "redirect:/mainAdmin/companies";
    }
    @RequestMapping(value = "/mainAdmin/deletecompany", method = RequestMethod.GET)
    public String redirect3() {
        return "redirect:/mainAdmin/companies";
    }
    @RequestMapping(value = "/mainAdmin/searchcompany", method = RequestMethod.GET)
    ...
    private void loadPage(Model model, ModelAndView modelAndView) {
        ...
        modelAndView.setViewName("mainAdmin/companies");
    }
