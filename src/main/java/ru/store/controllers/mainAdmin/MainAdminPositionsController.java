 ...
 */
@Controller
public class MainAdminPositionsController {
    ...
    @RequestMapping(value = "/mainAdmin/positions", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/mainAdmin/addsubpartitions", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/mainAdmin/positionsearchcompany", method = RequestMethod.POST)
    ...
    private void loadPage(Model model, ModelAndView modelAndView) {
        ...
        modelAndView.setViewName("mainAdmin/positions");
    }
    ...
    @RequestMapping(value = "/mainAdmin/addsubpartitions", method = RequestMethod.GET)
    public String redirect1() {
        return "redirect:/mainAdmin/positions";
    }
    @RequestMapping(value = "/mainAdmin/positionsearchcompany", method = RequestMethod.GET)
