 ...
 */
@Controller
public class MainAdminUsersController {

    @Autowired
    private UserService userService;

    @RequestMapping(value = "/mainAdmin/users", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/mainAdmin/adduser", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/mainAdmin/updateuser", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/mainAdmin/deleteuser", method = RequestMethod.POST)
    ...
    private void loadPage(Model model, ModelAndView modelAndView) {
        ...
        modelAndView.setViewName("mainAdmin/users");
    ...
    @RequestMapping(value = "/mainAdmin/adduser", method = RequestMethod.GET)
     public String redirect1() {
        return "redirect:/mainAdmin/users";
    }
    @RequestMapping(value = "/mainAdmin/updateuser", method = RequestMethod.GET)
    public String redirect2() {
        return "redirect:/mainAdmin/users";
    }
    @RequestMapping(value = "/mainAdmin/deleteuser", method = RequestMethod.GET)
