...
@Controller
public class MainAdminPartitionsController {
    @Autowired
    private PartitionService partitionService;
    @Autowired
    private SubPartitionService subPartitionService;
    @RequestMapping(value = "/mainAdmin/partitions", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/mainAdmin/addpartition", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/mainAdmin/updatepartition", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/mainAdmin/deletepartition", method = RequestMethod.POST)
    ...
    private void loadPage(Model model, ModelAndView modelAndView) {
        ...
        modelAndView.setViewName("mainAdmin/partitions");
    }
    ...
    @RequestMapping(value = "/mainAdmin/addpartition", method = RequestMethod.GET)
    public String redirect1() {
        return "redirect:/mainAdmin/partitions";
    }
    @RequestMapping(value = "/mainAdmin/updatepartition", method = RequestMethod.GET)
    public String redirect2() {
        return "redirect:/mainAdmin/partitions";
    }
    @RequestMapping(value = "/mainAdmin/deletepartition", method = RequestMethod.GET)
