    ...
    <div class="menuBody">
        <div class="generalContent">
            ...
            <form:form action="addcompany" modelAttribute="company" method="post" id="createForm">
                ...
                <%@include file="/WEB-INF/views/mainAdmin/components/address.jspf"%>
            ...
            <form:form action="updatecompany" modelAttribute="company" method="post" id="updateForm">
                ...
                <%@include file="/WEB-INF/views/mainAdmin/components/updateAddress.jspf"%>
...
<script type="text/javascript" src="<c:url value="/resources/js/mainAdminUsers.js" />"></script>
<style>
