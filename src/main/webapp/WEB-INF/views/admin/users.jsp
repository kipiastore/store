    ...
    <div class="menuBody">
        <div class="generalContent">
            ...
            <form:form action="adduser" modelAttribute="user" method="post" id="createForm">
                ...
                <input title="Логин пользователя может содержать латинские буквы, цифры, знаки дефиса, подчеркивания. От 4 до 20 символов."
            ...
            <form:form action="updateuser" modelAttribute="user" method="post" id="updateForm">
                ...
                <input id="username" type="text" disabled pattern="(^[\w+]{4,20}$)" name="username"
                       title="Логин пользователя может содержать латинские буквы, цифры, знаки дефиса, подчеркивания. От 4 до 20 символов.">
