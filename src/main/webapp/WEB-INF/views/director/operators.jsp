...
<div class="body">
    ...
    <div class="menuBody">
        <div class="generalContent">
            ...
            <form:form action="addoperator" modelAttribute="user" method="post" id="createForm">
                <label>Ф.И.О</label>
                ...
                <input title="Логин оператора может содержать латинские буквы, цифры, знаки дефиса, подчеркивания. От 4 до 20 символов."
            ...
            <form:form action="updateoperator" modelAttribute="user" method="post" id="updateForm">
                <label>Ф.И.О.</label>
                ...
                <input id="username" type="text" disabled pattern="(^[\w+]{4,20}$)" name="username"
                       title="Логин оператора может содержать латинские буквы, цифры, знаки дефиса, подчеркивания. От 4 до 20 символов.">
...
<div class="menu">
    <div class="menuTitle">
        <span class="menuTitleText">Операторы</span>
    </div>
    <div class="menuBody">
        <form:form action="deleteoperator" method="post" id="deleteForm">
...
<script type="text/javascript" src="<c:url value="/resources/js/director/directorOperators.js" />"></script>
</body>
</html>
