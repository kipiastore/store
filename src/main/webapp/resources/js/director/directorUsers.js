...
$(".menuBodyItemInfo").on("click", function (event) {
    ...
    if (pageInformation == undefined)
        pageInformation = $("#pageInformation").val();
    if (!(pageInformation == 4 || pageInformation == 5 || pageInformation == 6 || pageInformation == 7|| pageInformation == 1))
        return;
    $(".error").hide();
    $(".success").hide();
    updateForm = $("#updateForm");
    ...
    if (pageInformation == 4 || pageInformation == 5|| pageInformation == 6|| pageInformation == 7) {
        if (data == undefined) {
